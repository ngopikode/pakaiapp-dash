...
Schedule::command('pakaiapp:run-ai-pricing')->everyMinute()->withoutOverlapping()->onOneServer();
Schedule::command('orders:cancel-expired')->everyMinute()->withoutOverlapping()->onOneServer();
