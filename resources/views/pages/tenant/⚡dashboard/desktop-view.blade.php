...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start mb-4 gap-3 pt-3">
    ...
    <div class="d-flex flex-column align-items-md-end w-100 w-md-auto mt-2 mt-md-0 gap-3">
        ...
        <div
            class="d-flex align-items-center justify-content-between gap-3 py-2 px-3 rounded-pill border bg-body shadow-sm w-100 w-md-auto"
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="d-flex flex-column lh-1">
                    <span class="text-secondary small fw-bold"
                          style="font-size: 0.6rem; letter-spacing: 1px; text-transform: uppercase;">Saldo Pakaiapp</span>
                    <div class="d-flex align-items-center gap-2 mt-1">
                            <span
                        ...
                        @if($stats['wallet_balance'] >= 3000)
                            <span class="badge bg-body-tertiary text-secondary border fw-medium"
                                  style="font-size: 0.6rem; padding: 2px 6px;">~{{ floor($stats['wallet_balance'] / $stats['fee_per_trx']) }} trx</span>
                        @else
                            <span
                                class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-10 fw-medium animate-pulse"
                                style="font-size: 0.6rem; padding: 2px 6px;">Habis!</span>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-2 p-md-4 position-relative z-1 d-flex flex-column justify-content-between"
                    ...
                    <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            <p class="text-secondary small fw-bold mb-0 opacity-75"
                               style="font-size: 0.65rem;">{{ $stats['orders_today'] }} Transaksi
            ...
            <div
                ...
                <div class="card-body p-2 p-md-4 position-relative z-1 d-flex flex-column justify-content-between"
                    ...
                    <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            <p class="text-secondary small fw-bold mb-0 opacity-75" style="font-size: 0.65rem;">
                                Pendapatan
        ...
        <div class="col-xl-8">
            <div class="row g-3 g-md-4 align-items-start">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="card dash-card bg-body border w-100"
                         style="border-color: var(--bs-border-color-translucent) !important;">
                ...
                <div class="col-md-6">
                    <div class="card dash-card bg-body border w-100"
                        ...
                        <div class="card-header bg-transparent border-0 pt-4 pb-2 px-4">
                            <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;"><i
                                    class="bi bi-shop-window me-2 text-warning"></i>Sumber Pesanan (Bulan Ini)</h6>
                        </div>
                        <div class="card-body p-3 p-md-4 pt-2">
            ...
            <div class="row g-3 g-md-4 mt-0 align-items-start">
                <div class="col-md-6">
                    {{-- Widget Produk Kurang Laku --}}
                    <div class="card dash-card h-100 p-2 bg-body border"
                         style="border-color: var(--bs-border-color-translucent) !important;">
                        <div class="card-header border-0 bg-transparent pt-3 px-3 d-flex align-items-center gap-2">
                            ...
                            <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;">Perlu
                                Perhatian (Kurang Laku)</h6>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card dash-card h-100 p-2 bg-body border"
                        ...
                        <div class="card-header border-0 bg-transparent pt-3 px-3 d-flex align-items-center gap-2">
                            ...
                            <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;">Waktu
                                Penjualan Tersibuk</h6>
                        </div>
                        <div class="card-body p-3 pt-1 bg-body">
                            @if(count($peakSalesTimes) > 0)
                                ...
                                <div class="mt-2 text-center">
                                    <small class="text-secondary opacity-75" style="font-size: 0.65rem;">Berdasarkan 30
                                        hari terakhir</small>
                                </div>
                            @else
                                <div class="text-center py-4 rounded-4 bg-body-tertiary border">
