                    ...
                    <div class="d-flex flex-column lh-1">
                        ...
                        <div class="d-flex align-items-center gap-2 mt-1">
                            ...
                            @if($stats['wallet_balance'] >= 3000)
                                <span class="badge bg-body-tertiary text-secondary border fw-medium" style="font-size: 0.6rem; padding: 2px 6px;">~{{ floor($stats['wallet_balance'] / $stats['fee_per_trx']) }} trx</span>
                            @else
                                <span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-10 fw-medium animate-pulse" style="font-size: 0.6rem; padding: 2px 6px;">Habis!</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-8">
                ...
                <div class="row g-3 g-md-4 mt-0 align-items-start">
                    <div class="col-md-6">
                        ...
                        <div class="card dash-card h-100 p-2 bg-body border" style="border-color: var(--bs-border-color-translucent) !important;">
