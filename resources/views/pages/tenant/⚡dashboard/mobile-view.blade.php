...
<div class="d-flex flex-column mb-3 gap-3 pt-2">
    <div>
        ...
        <h2 class="page-store-name mb-0 d-flex align-items-center gap-2 fs-3">
            ...
            @if($store)
                <span
                    class="badge bg-success bg-opacity-10 text-success rounded-pill px-2 py-1 fw-bold d-flex align-items-center gap-1 border border-success border-opacity-10"
    ...
    <div class="d-flex flex-column w-100 gap-2 mt-1">
        ...
        <div
            class="d-flex align-items-center justify-content-between gap-3 py-2 px-3 rounded-4 border bg-body shadow-sm w-100"
            style="border-color: var(--bs-border-color-translucent) !important;">
            <div class="d-flex align-items-center gap-2">
                <div
                    class="rounded-circle d-flex align-items-center justify-content-center bg-warning bg-opacity-10 text-warning flex-shrink-0"
                    style="width: 32px; height: 32px;">
                    <i class="bi bi-wallet2 fs-6"></i>
                </div>
                <div class="d-flex flex-column lh-1">
                    <span class="text-secondary small fw-bold"
                          style="font-size: 0.6rem; letter-spacing: 1px; text-transform: uppercase;">Saldo Anda</span>
                    <div class="d-flex align-items-center gap-2 mt-1">
                            <span
                                class="fw-bold text-body {{ $stats['wallet_balance'] < 3000 ? 'text-danger animate-pulse' : '' }}"
                                style="font-family: var(--font-serif), sans-serif; font-size: 1rem;">
            ...
            <div class="border-start ps-3 py-1">
                <button class="btn btn-sm p-0 text-primary fw-bold hover-translate" data-bs-toggle="modal"
                        data-bs-target="#topUpModal" style="font-size: 0.8rem;" type="button">
        ...
        <div class="d-flex flex-row gap-2 w-100">
            <button wire:click="exportLaporan"
                ...
                <span wire:loading.remove wire:target="exportLaporan"><i
                        class="bi bi-file-earmark-excel-fill text-success fs-6 me-1"></i> Rekap</span>
...
@else
    ...
    <div class="row g-2 mb-3">
                ...
                <div class="card-body p-2 position-relative z-1 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <span class="badge text-secondary border rounded-pill px-2 py-1 bg-body-tertiary"
                              style="font-size: 0.6rem;">Hari Ini</span>
                    </div>
                    <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            <p class="text-secondary fw-bold mb-0 opacity-75"
                               style="font-size: 0.6rem;">{{ $stats['orders_today'] }} Trx</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-6">
            <div class="card h-100 dash-card position-relative overflow-hidden border bg-body p-2">
                <div class="card-body p-2 position-relative z-1 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <span class="badge text-secondary border rounded-pill px-2 py-1 bg-body-tertiary"
                              style="font-size: 0.6rem;">Bulan Ini</span>
                    </div>
                    <div>
                        <div class="text-body fw-bold mb-1" style="font-size: 1.15rem; letter-spacing: -0.5px;">
        ...
        <div class="col-12 mt-2">
            <div
                class="card dash-card position-relative overflow-hidden border bg-body p-2 {{ $stats['pending_orders'] > 0 ? 'border-danger border-2' : 'border-secondary border-opacity-25' }}"
                ...
                <div class="card-body p-2 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <div
                                class="fw-bold {{ $stats['pending_orders'] > 0 ? 'text-danger' : 'text-body' }} fs-5 lh-1">
                    ...
                    @if($stats['pending_orders'] > 0)
                        <a href="{{ route('cashier') }}"
                           class="btn btn-sm btn-danger rounded-pill fw-bold px-3">Proses</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card dash-card bg-body border"
                ...
                <div class="card-header bg-transparent border-0 pt-3 px-3">
                    <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;"><i
                            class="bi bi-graph-up text-primary me-2"></i>Trend Pendapatan (7 Hari)</h6>
                </div>
    ...
    <div class="d-flex flex-column gap-3 pb-5">
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-body p-3 bg-body">
                ...
                <a href="{{ route('product.create') }}" wire:navigate.hover
                   class="quick-action-btn d-flex align-items-center gap-3 p-3 text-decoration-none text-body rounded-4 border bg-body-tertiary shadow-sm">
                    <div
                    ...
                    <div>
                        ...
                        <small class="text-secondary d-block opacity-75" style="font-size: 0.65rem;">Perbarui katalog
                            jualanmu</small>
                    </div>
                </a>
            </div>
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-header border-0 bg-transparent pt-3 px-3 d-flex align-items-center gap-2">
                ...
                <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;">Menu Terlaris
                    (Bulan Ini)</h6>
            </div>
                    ...
                    <div class="d-flex flex-column gap-2">
                        @foreach($topProducts as $index => $item)
                            <div
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div
                                        class="rank-badge-solid {{ $index == 0 ? 'gold' : ($index == 1 ? 'silver' : ($index == 2 ? 'bronze' : 'other')) }}">
                                        {{ $index + 1 }}
                                    </div>
                                    <div class="fw-bold small text-truncate text-body"
                                         style="max-width: 140px;">{{ $item->product_name }}</div>
                                </div>
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-header border-0 bg-transparent pt-3 px-3">
                <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;"><i
                        class="bi bi-credit-card-2-front-fill me-2 text-primary"></i>Metode Pembayaran</h6>
            </div>
                    ...
                    <div class="d-flex flex-column gap-3">
                        @foreach($paymentMethods as $pm)
                            ...
                            <div>
                                ...
                                <div class="progress"
                                     style="height: 8px; border-radius: 4px; background-color: var(--bs-secondary-bg);">
                                    <div class="progress-bar bg-{{$c}}" role="progressbar" style="width: {{$pct}}%"
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-header border-0 bg-transparent pt-3 px-3">
                <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;"><i
                        class="bi bi-shop-window me-2 text-warning"></i>Sumber Pesanan</h6>
            </div>
            <div class="card-body p-3 pt-1">
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-header border-0 bg-transparent pt-3 px-3 d-flex align-items-center gap-2">
                ...
                <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;">Perlu Perhatian
                    (Kurang Laku)</h6>
            </div>
            <div class="card-body p-3 pt-1 bg-body">
        ...
        <div class="card dash-card p-2 bg-body border"
            ...
            <div class="card-header border-0 bg-transparent pt-3 px-3 d-flex align-items-center gap-2">
                ...
                <h6 class="fw-bold mb-0 text-body" style="font-family: var(--font-serif), sans-serif;">Waktu Penjualan
                    Tersibuk</h6>
            </div>
            <div class="card-body p-3 pt-1 bg-body">
