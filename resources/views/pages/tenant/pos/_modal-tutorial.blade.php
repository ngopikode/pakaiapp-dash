            ...
            <div class="modal-body p-4 bg-body overflow-y-auto">
                ...
                @if($mode === 'retail')
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-secondary small max-w-lg mx-auto">Ikuti langkah mudah di bawah ini untuk mengoperasikan kasir ritel secara cepat, efisien, dan presisi.</p>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    <div class="bg-primary bg-opacity-10 text-primary rounded-4 d-flex align-items-center justify-content-center p-2.5" style="width: 48px; height: 48px;">
                                        <i class="bi bi-qr-code-scan fs-4"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-1 text-body">Pindai Barcode Langsung</h6>
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Arahkan scanner dan tembak barcode produk kapan saja tanpa perlu mengklik kolom pencarian. Sistem akan otomatis memasukkannya ke keranjang.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    <div class="bg-warning bg-opacity-10 text-warning rounded-4 d-flex align-items-center justify-content-center p-2.5" style="width: 48px; height: 48px;">
                                        <i class="bi bi-tag fs-4"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-1 text-body">Diskon & Stok Ketat</h6>
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Masukkan nominal diskon per item secara langsung di dalam keranjang belanja. Jumlah stok akan otomatis terpotong saat transaksi selesai.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    <div class="bg-success bg-opacity-10 text-success rounded-4 d-flex align-items-center justify-content-center p-2.5" style="width: 48px; height: 48px;">
                                        <i class="bi bi-pause-circle fs-4"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-1 text-body">Tunda Pesanan (F8)</h6>
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Pelanggan belum selesai memilih? Klik <strong>Tunda</strong> untuk menyimpan keranjang secara aman di memori lokal, lalu panggil kembali melalui tombol <strong>Daftar</strong>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    <div class="bg-info bg-opacity-10 text-info rounded-4 d-flex align-items-center justify-content-center p-2.5" style="width: 48px; height: 48px;">
                                        <i class="bi bi-whatsapp fs-4"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-1 text-body">Struk Digital WhatsApp</h6>
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Kirimkan struk belanja secara digital ke WhatsApp pelanggan. Masukkan nomor WhatsApp di keranjang atau langsung setelah transaksi selesai.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 p-3 rounded-4" style="background: rgba(var(--bs-primary-rgb), 0.05); border: 1px dashed rgba(var(--bs-primary-rgb), 0.3);">
                        <h6 class="fw-bold mb-2 text-primary"><i class="bi bi-keyboard me-2"></i>Pintasan Cepat Keyboard (Keyboard Hotkeys)</h6>
                        <div class="row g-2 text-secondary" style="font-size: 0.8rem;">
                            <div class="col-md-4">
                                <span class="badge bg-body border text-secondary py-2 w-100 text-start d-flex justify-content-between align-items-center">
                                    <span><kbd class="bg-dark text-white px-1 rounded small">F2</kbd> Lanjut Bayar</span>
                            ...
                            <div class="col-md-4">
                                <span class="badge bg-body border text-secondary py-2 w-100 text-start d-flex justify-content-between align-items-center">
                                    <span><kbd class="bg-dark text-white px-1 rounded small">F8</kbd> Tunda / Daftar</span>
                ...
                @else
                    {{-- ===== RESTO MODE TUTORIAL ===== --}}
                    <div class="text-center mb-4">
                        <span class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 rounded-pill fw-bold px-3 py-1.5 mb-2" style="font-size: 0.8rem; color: #b45309 !important;">
                            <i class="bi bi-cup-hot me-1"></i>Mode Restoran & Cafe (F&B)
                        </span>
                        <h4 class="fw-bold text-body">Kelola Pesanan Meja & Dapur 🍽️</h4>
                        <p class="text-secondary small max-w-lg mx-auto">Aliran transaksi restoran dari meja pelanggan, catatan pesanan ke dapur, hingga pelunasan di kasir secara teratur.</p>
                    </div>
                            ...
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Tuliskan catatan khusus per menu (seperti <em>"tanpa es"</em> atau <em>"tidak pedas"</em>) langsung dari kolom input catatan di bawah setiap item keranjang belanja.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Gunakan tombol <strong>Simpan Antrian</strong> jika pelanggan memesan terlebih dahulu dan akan membayar nanti setelah selesai makan. Dapur dapat langsung melihat catatan.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Pajak resto (PB1 10%) dan biaya pelayanan (5%) otomatis dihitung. Anda dapat mematikan atau menyalakan keduanya lewat sakelar (switch) di keranjang.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 p-3 border shadow-sm bg-body-tertiary" style="border-radius: 1.25rem; border-color: var(--bs-border-color-translucent) !important;">
                                <div class="d-flex gap-3 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary small mb-0" style="font-size: 0.8rem;">Ketika pelanggan siap membayar, buka tab <strong>Daftar Antrean</strong>, cari invoice mereka, dan klik <strong>Bayar Sekarang</strong> untuk menyelesaikan pelunasan.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 p-3 rounded-4" style="background: rgba(var(--bs-primary-rgb), 0.05); border: 1px dashed rgba(var(--bs-primary-rgb), 0.3);">
                        ...
                        <div class="row g-2 text-secondary" style="font-size: 0.8rem;">
                            <div class="col-6 col-md-3">
                                <span class="badge bg-body border text-secondary py-2 w-100 text-start d-flex justify-content-between align-items-center">
                                    <span><kbd class="bg-dark text-white px-1 rounded small">F2</kbd> Bayar Langsung</span>
                                    <i class="bi bi-lightning text-danger"></i>
                                </span>
                            </div>
                            <div class="col-6 col-md-3">
                                <span class="badge bg-body border text-secondary py-2 w-100 text-start d-flex justify-content-between align-items-center">
                                    <span><kbd class="bg-dark text-white px-1 rounded small">F3</kbd> Simpan Antrean</span>
