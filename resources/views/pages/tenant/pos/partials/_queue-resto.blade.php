                                ...
                                <div class="pe-2 text-slate-900 dark:text-slate-100">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            @endif
                                            @if($item->discount > 0)
                                                <div class="mt-1 text-xs font-bold text-emerald-600 dark:text-emerald-400"><i class="ph-fill ph-tag me-1"></i>Hemat Rp {{ number_format($item->discount * $item->quantity, 0, ',', '.') }}</div>
                                            @endif
                                            @if($item->note)
                                                <div class="mt-1 text-xs italic text-amber-600 dark:text-amber-400"><i class="ph-bold ph-chat-circle-dots me-1"></i>{{ $item->note }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
