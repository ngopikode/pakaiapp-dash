...
<div
    ...
    class="fixed inset-0 bg-[var(--foreground)]/60 backdrop-blur-md z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4"
    style="display: none;"
>
    {{-- Modal Sheet / Dialog --}}
    <div
        ...
        <div class="flex-1 overflow-y-auto px-6 py-5 space-y-4">
            ...
            <template x-if="orderHistory.length === 0 && !historyLoading">
                <div class="py-12 px-4 text-center flex flex-col items-center justify-center">
                    ...
                    <h3 class="text-sm font-black text-[var(--foreground)] mb-1">Belum Ada Transaksi</h3>
                    <p class="text-[11px] text-[var(--text-secondary)] max-w-[240px] leading-relaxed font-medium mb-6">
                        Setiap pesanan yang kamu buat di toko ini akan otomatis tercatat dan tersimpan rapi di sini.
                    </p>
                    <button
                        @click="historyOpen = false"
                        class="px-5 py-3 bg-[var(--foreground)] hover:bg-zinc-700 text-[var(--background)] rounded-xl text-xs font-black uppercase tracking-wider shadow-lg shadow-[var(--foreground)]/20 active:scale-95 transition-all"
                    >
                        Mulai Belanja
                    </button>
                </div>
            ...
            <template x-if="historyLoading">
                <div class="py-12 text-center flex flex-col items-center justify-center">
                    ...
                    <p class="text-xs font-bold text-[var(--text-secondary)] uppercase tracking-widest">Memuat Terbaru...</p>
                </div>
            </template>
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between pb-3 border-b border-black/5 dark:border-white/5">
                                <div>
                                    ...
                                    <span class="text-[9px] font-bold text-[var(--text-secondary)] uppercase tracking-wide mt-1 block"
                                ...
                                <div class="flex flex-col gap-1.5 items-end shrink-0">
                                    ...
                                    <span class="text-[8px] text-[var(--text-secondary)] font-bold uppercase tracking-widest"
                            ...
                            <div class="space-y-1 py-1">
                                <template x-for="item in order.items">
                                    <div
                                        class="flex items-center justify-between text-[11px] font-semibold text-[var(--text-secondary)]">
                                        <div class="flex items-center gap-1.5 truncate max-w-[240px]">
                                            <span class="text-[var(--text-secondary)] font-bold" x-text="item.qty + 'x'"></span>
                                            <span class="truncate" x-text="item.name"></span>
                                        </div>
                                        <span class="text-[var(--foreground)] shrink-0 font-bold"
