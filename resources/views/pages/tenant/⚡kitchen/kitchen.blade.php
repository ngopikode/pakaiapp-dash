<div class="min-h-screen bg-slate-950 p-4 text-slate-200 md:p-6 lg:p-8" x-data="{ stats: @js($this->kitchenStats) }">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-400">Real-time operations dashboard</p>
        </div>
        <div class="flex flex-wrap items-center gap-3">
            <span class="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-2 text-sm font-bold text-emerald-400">
    ...
    <div class="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/50 p-4">
            <div class="flex items-center justify-between">
                <span class="text-3xl font-black text-white">{{ $this->kitchenStats['active'] }}</span>
                <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-amber-500">
            ...
            <div class="mt-2 flex items-center gap-2">
                ...
                <span class="rounded-full bg-slate-800 px-2 py-0.5 text-[10px] font-bold text-slate-400">Today</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/50 p-4">
            <div class="flex items-center justify-between">
                <span class="text-3xl font-black text-white">{{ $this->kitchenStats['avg_prep'] }}m</span>
                <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-sky-500">
            ...
            <div class="mt-2 flex items-center gap-2">
                ...
                <span class="rounded-full bg-slate-800 px-2 py-0.5 text-[10px] font-bold text-slate-400">Avg</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/50 p-4">
            ...
            <div class="mt-2 flex items-center gap-2">
                ...
                <span class="rounded-full bg-slate-800 px-2 py-0.5 text-[10px] font-bold text-slate-400">Waiting</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-slate-800 bg-slate-900/50 p-4">
            ...
            <div class="mt-2 flex items-center gap-2">
                ...
                <span class="rounded-full bg-slate-800 px-2 py-0.5 text-[10px] font-bold text-slate-400">Done</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        {{-- Kolom Pending --}}
        <div class="flex flex-col rounded-2xl border border-red-500/20 bg-red-950/20 p-4">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="flex items-center gap-2 text-lg font-black text-red-400">
                    <span class="flex h-7 w-7 items-center justify-center rounded-full bg-red-500/20 text-sm">{{ $waitingBatches->count() }}</span>
                    Pending
                </h3>
                <span class="text-xs font-bold uppercase tracking-wider text-red-400/70">Menunggu</span>
            </div>
            ...
            <div class="flex flex-1 flex-col gap-4 overflow-y-auto">
                ...
                @empty
                    <div class="flex flex-1 flex-col items-center justify-center py-12 text-center">
                        ...
                        <p class="text-sm font-medium text-slate-500">Antrean kosong</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        {{-- Kolom Cooking --}}
        <div class="flex flex-col rounded-2xl border border-amber-500/30 bg-amber-950/20 p-4 shadow-lg shadow-amber-500/10">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="flex items-center gap-2 text-lg font-black text-amber-400">
                    <span class="flex h-7 w-7 items-center justify-center rounded-full bg-amber-500/20 text-sm">{{ $processingBatches->count() }}</span>
                    Cooking
                </h3>
                <span class="text-xs font-bold uppercase tracking-wider text-amber-400/70">Memasak</span>
            </div>
            ...
            <div class="flex flex-1 flex-col gap-4 overflow-y-auto">
                ...
                @empty
                    <div class="flex flex-1 flex-col items-center justify-center py-12 text-center">
                        ...
                        <p class="text-sm font-medium text-slate-500">Tidak ada yang dimasak</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        {{-- Kolom Ready --}}
        <div class="flex flex-col rounded-2xl border border-emerald-500/20 bg-emerald-950/20 p-4">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="flex items-center gap-2 text-lg font-black text-emerald-400">
                    <span class="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-500/20 text-sm">{{ $readyBatches->count() }}</span>
                    Ready
                </h3>
                <span class="text-xs font-bold uppercase tracking-wider text-emerald-400/70">Selesai</span>
            </div>
            ...
            <div class="flex flex-1 flex-col gap-4 overflow-y-auto">
                ...
                @empty
                    <div class="flex flex-1 flex-col items-center justify-center py-12 text-center">
                        ...
                        <p class="text-sm font-medium text-slate-500">Belum ada yang siap</p>
                    </div>
                @endforelse
            </div>
        </div>
