        ...
        <form wire:submit="sendResetLink" class="space-y-6">
            ...
            <div class="pt-2 space-y-4">
                ...
                <div class="text-center">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-brand-accent transition-colors group/back" wire:navigate.hover>
                        <svg class="w-4 h-4 transition-transform duration-300 group-hover/back:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                        </svg>
                        Kembali ke Login
                    </a>
