    ...
    <main class="main-container">
        <div class="login-card">
            ...
            <form id="formLogin">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="login_input" placeholder="budi@email.com atau kopi-mantap" required autofocus>
                    </div>
            ...
            <div class="mt-4 text-center">
                <span class="text-muted small">Belum punya toko? <a href="/register" class="text-accent text-decoration-none fw-bold">Daftar Sekarang</a></span>
            </div>
        </div>
    </main>
