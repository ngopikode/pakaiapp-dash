...
<nav class="sticky top-0 z-40 w-full bg-white/85 dark:bg-[#0B1120]/85 backdrop-blur-xl border-b border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between gap-3 px-4 lg:px-8 h-16 lg:h-[72px] transition-colors" id="mainNavbar">
    ...
    @if(!$isPosNavbar)
        @island(name: 'notification-badge', defer: true)
            @placeholder
                <div class="relative">
                    <button class="relative p-2 text-slate-500 dark:text-slate-400 rounded-xl hover:bg-slate-100/80 dark:hover:bg-slate-800/50 transition-colors focus:outline-none" disabled>
