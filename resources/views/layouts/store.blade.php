...
<div class="text-center max-w-sm">
    ...
    <p class="text-sm text-[var(--text-secondary)] mb-6 max-w-xs">Toko ini sedang dinonaktifkan sementara oleh pemiliknya.</p>
...
@else
    ...
    >
        ...
        <div
            ...
            style="display:none"
        >
            <div @click.outside="contactOpen = false; $dispatch('close-contact-modal')" class="bg-[var(--surface)] w-full max-w-sm rounded-3xl p-6 text-center relative overflow-hidden shadow-2xl">
                <div class="w-12 h-12 bg-[var(--bg-soft)] rounded-full flex items-center justify-center mx-auto mb-4 text-[var(--foreground)]">
                ...
                <div class="bg-[var(--background)] rounded-2xl p-4 space-y-4 text-left">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Telepon / WA</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Alamat</p>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Email Support</p>
                ...
                <div class="mt-6 pt-4 border-t border-[var(--border)]">
                    <p class="text-[10px] text-[var(--text-secondary)]">Platform dikembangkan oleh <span class="font-bold text-[var(--text-secondary)]">pakaiapp.online</span></p>
                </div>
                
                <button @click="contactOpen = false; $dispatch('close-contact-modal')" class="mt-6 w-full bg-[var(--foreground)] text-[var(--background)] py-3.5 rounded-xl text-xs font-black uppercase tracking-wider hover:bg-zinc-700 transition-colors">
                    Tutup
                </button>
            </div>
        </div>
        ...
        <div
            ...
            style="display:none"
        >
            <div @click.stop class="bg-[var(--surface)] w-full max-w-xs rounded-2xl p-8 text-center relative overflow-hidden">
                <div
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-widest mb-6">Buka di Ponsel
                        Anda</p>
