...
<head>
    ...
    <meta name="description" content="{{ $setting->seo_description ?: 'Platform menu digital untuk semua jenis usaha.' }}"/>
    ...
    <meta property="og:description" content="{{ $setting->og_description ?: 'Buat menu online untuk usaha Anda.' }}"/>
    @if($setting->og_image)
