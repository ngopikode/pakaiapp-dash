...
If you customize the pluralizer's language, you should explicitly define your Eloquent model's [table names](../eloquent-orm/eloquent.md#table-names).
...
If you are using the [Blade templating engine](../the-basics/blade.md), you may use the `{{ }}` echo syntax to display the translation string:
