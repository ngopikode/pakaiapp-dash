...
The Laravel `Hash` [facade](../architecture-concepts/facades.md) provides secure Bcrypt and Argon2 hashing for storing user passwords. If you are using one of the [Laravel application starter kits](../getting-started/starter-kits.md), Bcrypt will be used for registration and authentication by default.
