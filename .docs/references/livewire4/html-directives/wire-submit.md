...
* [Responding to browser events with Livewire](../essentials/actions.md)

* [Creating forms in Livewire](../essentials/forms.md)
...
`.prevent`
Prevents default browser behavior (automatic for `wire:submit`)
