...
This page is a simple reference for the `wire:navigate` directive. Be sure to read the [page on Livewire's Navigate feature](../features/navigate.md) for more complete documentation.
...
For more complete documentation on this feature, visit [Livewire's navigate documentation page](../features/navigate.md).
## See also
...
* [@persist](../blade-directives/directive-persist.md) — Persist elements during navigation
