...
* [wire:show](wire-show.md) — Toggle visibility with CSS display

* [Loading States](../features/loading-states.md) — Show loading indicators during requests
...
(none)
Uses `match-element` as the view-transition-name

`"name"`
Uses the provided string as the view-transition-name
