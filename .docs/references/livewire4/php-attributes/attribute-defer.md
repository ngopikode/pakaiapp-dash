...
For complete documentation on lazy and deferred loading, including placeholders and bundling strategies, see the [Lazy Loading documentation](../features/lazy.md).
## Reference
