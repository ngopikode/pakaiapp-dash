...
For complete documentation on lazy loading, including placeholders, bundling strategies, and passing props, see the [Lazy Loading documentation](../features/lazy.md).
## Reference
...
`bool|null`
`null`
Bundle multiple lazy components into a single network request
