...
* [Navigate](navigate.md) — Use SPA navigation for redirects

* [Actions](../essentials/actions.md) — Redirect after action completion

* [Forms](../essentials/forms.md) — Redirect after successful form submission

* [Pages](../essentials/pages.md) — Navigate between page components
