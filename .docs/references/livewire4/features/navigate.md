...
* [Redirecting](redirecting.md) — Navigate programmatically from actions

* [@persist](../blade-directives/directive-persist.md) — Persist elements across page navigations

* [wire:navigate](../html-directives/wire-navigate.md) — Add SPA navigation to links
