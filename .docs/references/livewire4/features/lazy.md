...
* [Islands](islands.md) — Isolate updates within a single component

* [Loading States](loading-states.md) — Show placeholders while components load

* [@placeholder](../blade-directives/directive-placeholder.md) — Define placeholder content

* [Lazy Attribute](../php-attributes/attribute-lazy.md) — Mark components for lazy loading
