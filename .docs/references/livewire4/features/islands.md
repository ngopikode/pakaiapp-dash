...
* [Nesting](../essentials/nesting.md) — Alternative approach using child components

* [Lazy Loading](lazy.md) — Defer loading of expensive content

* [Computed Properties](computed-properties.md) — Optimize island performance with memoization

* [@island](../blade-directives/directive-island.md) — Create isolated update regions
