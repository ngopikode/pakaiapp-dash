...
PHP Attributes are restricted to certain syntaxes like plain strings and arrays. If you find yourself wanting to use run-time syntaxes like Laravel's Rule objects (`Rule::exists(...)`) you should instead `rules()`[define a  method](#defining-a-rules-method) in your component.
...
For more information on other testing utilities provided by Livewire, check out the [testing documentation](../essentials/testing.md).
...
* [Forms](../essentials/forms.md) — Validate form inputs with real-time feedback

* [Properties](../essentials/properties.md) — Validate property values before persisting

* [Validate Attribute](../php-attributes/attribute-validate.md) — Use #[Validate] for property validation

* [Actions](../essentials/actions.md) — Validate data in action methods
