...
Livewire offers [hooks](../essentials/lifecycle-hooks.md) for query strings as well.
...
* [Properties](../essentials/properties.md) — Sync properties with URL parameters

* [Navigate](navigate.md) — Maintain URL state during SPA navigation

* [Url Attribute](../php-attributes/attribute-url.md) — Bind properties to URL query strings

* [Pages](../essentials/pages.md) — Work with route parameters
