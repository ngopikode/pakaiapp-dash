...
If you need to persist simple values across page refreshes without cross-request caching, consider using the `#[Session]`[ attribute](../php-attributes/attribute-session.md) instead of computed properties.
...
[Learn more about session properties →](../php-attributes/attribute-session.md)
## See also

* [Properties](../essentials/properties.md) — Understand basic property management

* [Islands](islands.md) — Optimize performance with lazy computed values

* [Computed Attribute](../php-attributes/attribute-computed.md) — Use #[Computed] for memoization

* [Components](../essentials/components.md) — Access computed properties in views
