...
Components must have exactly one root HTML element. In this example, the `<form>` element is the single root. Multiple root elements or HTML comments outside the root element will cause an error. When rendering [full-page components](../essentials/pages.md), named slots for the layout can be placed outside the root element.
...
* [Components](../essentials/components.md) — Learn about single-file vs multi-file components, passing data, and more

* [Properties](../essentials/properties.md) — Understand how component properties work and their lifecycle

* [Actions](../essentials/actions.md) — Dive deeper into methods, parameters, and event handling

* [Forms](../essentials/forms.md) — Explore Livewire's powerful form features including real-time validation

* [Validation](../features/validation.md) — Master all of Livewire's validation capabilities
