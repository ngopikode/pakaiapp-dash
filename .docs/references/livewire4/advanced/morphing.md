...
If you need to bypass morphing entirely for an element, you can use [wire:replace](../html-directives/wire-replace.md) to instruct livewire to replace all children of an element instead of attempting to morph the existing elements.
## See also

* [Hydration](hydration.md) — Understand Livewire's request lifecycle

* [Components](../essentials/components.md) — How components render and update
