...
`rendering()`
Called before the component's view is rendered

`rendered()`
Called after the component's view is rendered
...
The technique used above is powerful; however, it's often better to use [Livewire's computed properties](../features/computed-properties.md) to solve this use case.
...
For more information, check out the [documentation on the Locked attribute](../php-attributes/attribute-locked.md).
...
It's worth noting that for this particular example, in an actual application, you should use the `#[Locked]`[ attribute](../php-attributes/attribute-locked.md) instead, like in the above example.
...
We often use the terms "hydrate" and "dehydrate" to refer to this process throughout Livewire's codebase and the documentation. If you'd like more clarity on these terms, you can learn more by [consulting our hydration documentation](../advanced/hydration.md).
