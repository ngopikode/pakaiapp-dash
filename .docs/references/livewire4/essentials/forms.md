...
Livewire has a lot more validation features to offer. For more information, visit our [dedicated documentation page on Validation](../features/validation.md).
...
By default, Livewire only sends a network request when the form is submitted (or any other [action](actions.md) is called), not while the form is being filled out.
...
For more information, check out the [validation documentation page](../features/validation.md).
...
To learn more about the "updated" lifecycle hook and other hooks, [visit the lifecycle hooks documentation](lifecycle-hooks.md).
