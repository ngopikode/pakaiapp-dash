...
For lazy component loading, see the [Lazy Loading documentation](../features/lazy.md).

For island loading states, see the [Islands documentation](../features/islands.md).
