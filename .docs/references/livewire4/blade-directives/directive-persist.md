...
[Learn more about wire:current →](../html-directives/wire-current.md)
## How it works
...
[Learn more about navigation →](../features/navigate.md)
## Reference
...
`string`
required
A unique name identifying the element to persist across page navigations
